...
public class HW4 {
    ...
    public static int enemyValueMin = 9;
    public static int enemyValueMax = 16;
    ...
    public static void fightingWithEnemy() {
        int a = enemyHP;
        while (isAlivePlayer() & a > 0) {
            playerHP -= enemyAttack;
            System.out.println("ALERT! Enemy give damage " + enemyAttack + ". Player HP now is " + playerHP);
            if (isAlivePlayer()) {
                a -= playerAttack;
                System.out.println("You hit the enemy and he has HP= " + a + "!");
            }
        }
        if (a <= 0){
            countEnemies--;
            System.out.println("You win this enemy and have " + countEnemies + " enemies left on this map . Remember you have HP= " + playerHP + "!");
        }
    }
}
